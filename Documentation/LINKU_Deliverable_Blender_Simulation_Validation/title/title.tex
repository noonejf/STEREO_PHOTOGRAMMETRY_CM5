...
\newcommand{\ReportTitle}{Blender Simulation Realism Validation for Tether Imaging}
...
\vspace{1cm}
\vspace{0.25cm}
{\textsc{\Large "Blender Simulation Realism Validation for Tether Imaging"}\par}
\vspace{0.5cm}
...
\textbf{Status:} Working draft, experiments pending\par
\vspace{0.5cm}
